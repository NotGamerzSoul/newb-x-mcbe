...
*/
  ...
  #define NL_GLOW_SHIMMER 0
  #undef NL_WEATHER_SPECK
  #define NL_WEATHER_SPECK 0
  #undef NL_SHOOTING_STAR
  #define NL_SHOOTING_STAR 0
  #undef NL_UNDERWATER_STREAKS
  #define NL_UNDERWATER_STREAKS 0
  #undef NL_RAIN_MIST_OPACITY
  #define NL_RAIN_MIST_OPACITY 0
  #undef NL_CLOUDY_FOG
  #define NL_CLOUDY_FOG 0
  #undef NL_ENTITY_EDGE_HIGHLIGHT
  #define NL_ENTITY_EDGE_HIGHLIGHT 0
  #undef NL_AURORA
  #define NL_AURORA 0
  #undef NL_GROUND_RAIN_PUDDLES
  #define NL_GROUND_RAIN_PUDDLES 0
#endif
